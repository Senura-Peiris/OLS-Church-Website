const translations = {
    ...
    si: {
      ...
      priestDesc:
        "අපගේ වත්මන් පියතුමා ගරු චමින්ද රොෂාන් මහතා දයාවෙන් හා ආගමික විශ්වාසයෙන් සමාජය සේවය කිරීමේ කැපවීමෙන් යුතුව සිටී. ඔහු පසුගිය වසර 1.5 ක් පුරා අපගේ දෙව්මැදුර නියෝජනය කරමින් සභාවට ආශිර්වාද හා ආදරය ලබාදී ඇත.",
      birthday: "උපන්දිනය: ",
      specialMoments: "විශේෂ මතකයන්",
      specialDesc:
        "අපගේ දෙව්මැදුරේ මතක සටහන් සහ ආගමික අවස්ථා දර්ශනය කරන මොහොතකි.",
